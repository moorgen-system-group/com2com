/**
 * @file app\tasks\fullduplex\fullduplex_ops.c
 *
 * Copyright (C) 2023
 *
 * fullduplex_ops.c is free software: you can redistribute it and/or modify
...
void fullduplex_ops_get(struct serial_mac_ops *ops)
{
    assert(ops);
    ops->fullduplex.serial_init = _serial_init;
    ops->fullduplex.serial_post = _serial_post;
    ops->fullduplex.timer_init = _timer_init;
    ops->fullduplex.timer_ctrl = _timer_ctrl;
    ops->fullduplex.event_init = _event_init;
    ops->fullduplex.event_post = _event_post;
    ops->fullduplex.event_get = _event_get;
}
